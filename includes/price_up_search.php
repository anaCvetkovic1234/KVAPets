<?php
          ...
          $the_id=$_SESSION['breed_id'];
          $query = "SELECT * FROM dogs WHERE dog_breed_id = $the_id AND status = 'published' ORDER BY dog_price ASC";
         ...
         <!--
          ...
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/<?php //echo $dog_image;  ?>" width="700" height="300" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#"><?php //echo $dog_name; ?></a>
              </h4>
                <p class="card-text"> <small><?php //echo $dog_adress;?></small> <br> <strong> <?php //echo "   ".$dog_price;?>&euro; </strong></p>
