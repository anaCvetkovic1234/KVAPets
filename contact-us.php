                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                          ...
                          <ul class="container details">
                            ...
                            <li><p><span class="glyphicon glyphicon-envelope one" style="width:50px;"></span>kva@gmail.com</p></li>
                            <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>Jurija Gagarina 64, Novi Beograd</p></li>
                            <li><p><span class="glyphicon glyphicon-new-window one" style="width:50px;"></span><a href="#">www.kva.rs</p></a>
                          </ul>
                        </div>
                    </div>
                </div>
